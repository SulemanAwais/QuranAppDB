...
public class _EnglishVersion extends AppCompatActivity {
    ListView listView;
    DBHelper helper;
    int pos=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_version);
...
//        listView = findViewById(R.id.list);
        ...
        listView.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            Intent intent = new Intent(_EnglishVersion.this, _EnglishVersionLayout.class);
